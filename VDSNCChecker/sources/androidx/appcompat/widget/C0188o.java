...
public class C0188o extends ImageView {

    /* renamed from: e */
    public final C0157f f867e;

    /* renamed from: f */
    public final C0186n f868f;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C0188o(Context context, AttributeSet attributeSet, int i) {
    ...
    public void drawableStateChanged() {
        ...
        C0157f fVar = this.f867e;
        if (fVar != null) {
            fVar.mo883a();
        }
        C0186n nVar = this.f868f;
        if (nVar != null) {
            nVar.mo1052a();
        }
    }
    ...
    public boolean hasOverlappingRendering() {
        if (!(!(this.f868f.f864a.getBackground() instanceof RippleDrawable)) || !super.hasOverlappingRendering()) {
            return false;
        }
        return true;
    }
