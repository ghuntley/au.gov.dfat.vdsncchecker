...
public class C0151e extends AutoCompleteTextView {

    /* renamed from: g */
    public static final int[] f746g = {16843126};

    /* renamed from: e */
    public final C0157f f747e;

    /* renamed from: f */
    public final C0134b0 f748f;

    public C0151e(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.autoCompleteTextViewStyle);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C0151e(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        C0230y0.m607a(context);
        C0216w0.m569a(this, getContext());
        C0136b1 q = C0136b1.m361q(getContext(), attributeSet, f746g, i, 0);
        if (q.mo775o(0)) {
    ...
    public void drawableStateChanged() {
        ...
        C0157f fVar = this.f747e;
        if (fVar != null) {
            fVar.mo883a();
        }
        C0134b0 b0Var = this.f748f;
        if (b0Var != null) {
            b0Var.mo748b();
        }
    }
