...
public class C1050e {
    ...
    /* renamed from: b */
    public static Method f3795b = null;

    /* renamed from: c */
    public static boolean f3796c = false;

    /* renamed from: d */
    public static Field f3797d;

    /* renamed from: j0.e$a */
    public interface C1051a {
        /* renamed from: h */
        boolean mo4384h(KeyEvent keyEvent);
    }

    /* renamed from: a */
    public static boolean m2995a(View view, KeyEvent keyEvent) {
        int indexOfKey;
        WeakHashMap<View, C1070q> weakHashMap = C1061o.f3808a;
        if (Build.VERSION.SDK_INT < 28) {
            ArrayList<WeakReference<View>> arrayList = C1061o.C1068f.f3816d;
            C1061o.C1068f fVar = (C1061o.C1068f) view.getTag(R.id.tag_unhandled_key_event_manager);
            if (fVar == null) {
                fVar = new C1061o.C1068f();
                view.setTag(R.id.tag_unhandled_key_event_manager, fVar);
            }
            WeakReference<KeyEvent> weakReference = fVar.f3819c;
            if (weakReference == null || weakReference.get() != keyEvent) {
                fVar.f3819c = new WeakReference<>(keyEvent);
                WeakReference weakReference2 = null;
                if (fVar.f3818b == null) {
                    fVar.f3818b = new SparseArray<>();
                }
                SparseArray<WeakReference<View>> sparseArray = fVar.f3818b;
    ...
    public static boolean m2996b(p058j0.C1050e.C1051a r7, android.view.View r8, android.view.Window.Callback r9, android.view.KeyEvent r10) {
        /*
            r0 = 0
        ...
        L_0x000f:
            ...
            f3795b = r1     // Catch:{ NoSuchMethodException -> 0x004a }
        L_0x004a:
            f3794a = r3
        L_0x004c:
            java.lang.reflect.Method r1 = f3795b
        ...
        L_0x0068:
            ...
            boolean r8 = p058j0.C1061o.m3023d(r7, r10)
        ...
        L_0x007e:
            ...
            f3797d = r7     // Catch:{ NoSuchFieldException -> 0x0095 }
            r7.setAccessible(r3)     // Catch:{ NoSuchFieldException -> 0x0095 }
        L_0x0095:
            f3796c = r3
        L_0x0097:
            java.lang.reflect.Field r7 = f3797d
        ...
        L_0x00d1:
            ...
            boolean r8 = p058j0.C1061o.m3023d(r8, r10)
        ...
        L_0x00e0:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p058j0.C1050e.m2996b(j0.e$a, android.view.View, android.view.Window$Callback, android.view.KeyEvent):boolean");
    }
}
